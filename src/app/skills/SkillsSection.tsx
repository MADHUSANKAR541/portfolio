...
export default function SkillsSection(props: { id?: string; dataAos?: string }) {
  return (
    <section className="section skills" id={props.id || undefined} data-aos={props.dataAos} style={{ scrollMarginTop: '100px' }}>
