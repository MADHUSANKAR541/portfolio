...
export default function AboutSection(props: { id?: string; dataAos?: string }) {
  return (
    <section className="section about" id={props.id || undefined} data-aos={props.dataAos} style={{ scrollMarginTop: '100px' }}>
